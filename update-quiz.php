...
const QUIZ_API_KEY = 'HZALYUv7FsJPnMoU2kef5zAWK8PW3z26';
...
$providedKey = $headers['X-Quiz-Key'] ?? $headers['x-quiz-key'] ?? ($_SERVER['HTTP_X_QUIZ_KEY'] ?? '');

if (!is_string($providedKey) || !hash_equals(QUIZ_API_KEY, $providedKey)) {
